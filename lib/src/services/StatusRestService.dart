...
class StatusRestService extends RestService {
    ...
    StatusRestService():super() {
        dependencyResolver.put('context-info', Descriptor('pip-services', 'context-info', 'default', '*', '1.0'));
    }
    ...
    void  setReferences(IReferences references) {
        ...
        _contextInfo = dependencyResolver.getOneOptional<ContextInfo>('context-info');
    }
    ...
    /// Registers all service routes in HTTP endpoint.
     @override
    void register() {
        registerRoute('get', _route, null, (angel.RequestContext req, angel.ResponseContext res) { _status(req, res); });
    }
    ...
    void _status(angel.RequestContext req, angel.ResponseContext res) {
        ...
        var uptime =  DateTime.now().subtract(Duration(milliseconds: _startTime.millisecondsSinceEpoch));
