...
abstract class RestOperations implements IConfigurable, IReferenceable {
    ...
    PagingParams getPagingParams(angel.RequestContext req) {
        ...
        params['skip'] = req.queryParameters['skip'];
        params['take'] = req.queryParameters['take'];
        params['total'] = req.queryParameters['total'];
    ...
    void sendConflict(angel.RequestContext req, angel.ResponseContext res, String message)  {
        var correlationId = getCorrelationId(req);
